...
- 图片: JS data 的每条数据都必须有 image 字段。必须从下方「Unsplash 图片库」按场景选取，不可自创 photo ID。URL 完整格式：https://images.unsplash.com/photo-{ID}?w=375&q=80，不同条目选不同 ID。
  【Unsplash 图片库 — 按主题选用】
  美食/餐厅: 1514362545857-3bc16c4c7d1b, 1559339352-11d035aa65de, 1467003909585-2f8a72700288, 1551963831-b3b1ca40c98e, 1544025162-d76694265947, 1553621042-f6e147245754, 1476124369491-e7addf5db371, 1453614512568-c4024d13c247, 1519708227418-c8fd9a32b7a2
  咖啡/饮品: 1497515114629-f71d768fd07c, 1559056199-641a0ac8b55e, 1497636577773-f1231844b336, 1481833761820-0509d3217039, 1498804103079-a6351b050096, 1495774856032-8b90bbb32b32, 1559305616-3f99cd43e353, 1442550528053-c431ecb55509
  时尚/服装: 1490481651871-ab68de25d43d, 1445205170230-053b83016050, 1434389677669-e08b4cac3105, 1503341455253-b2e723bb3dbb, 1560769629-975ec94e6a86, 1491553895911-0055eca6402d
  科技/电子: 1518770660439-4636190af475, 1461749280684-dccba630e2f6, 1505740420928-5e560c06d30e, 1523275335684-37898b6baf30, 1498050108023-c5249f4df085, 1531297484001-80022131f5a1
  商务/办公: 1497366216548-37526070297c, 1497366811353-6870744d04b2, 1486406146926-c627a92ad1ab, 1507679799987-c73779587ccf, 1521017432531-fbd92d768814
  人物/头像: 1494790108377-be9c29b29330, 1507003211169-0a1dd7228f2d, 1517841905240-472988babdf9, 1527980965255-d3b416303d12, 1520813792240-56fc4a3765a7, 1556228453-efd6c1ff04f6
  婚礼/典礼: 1519741497674-611481863552, 1511795409834-ef04bbd61622, 1546868871-7041f2a55e12, 1532712938310-34cb3982ef74, 1583939003579-730e3918a45a, 1549298916-b41d501d3772
  酒店/旅行: 1566073771259-6a8506099945, 1520250497591-112f2f40a3f4, 1455587734955-081b22074882, 1476514525535-07fb3b4ae5f1, 1576092768241-dec231879fc3, 1539109136881-3be0616acf4b
  健身/运动: 1544367567-0f2fcb009e0b, 1535914254981-b5012eebbd15, 1485965120184-e220f721d03e, 1526506118085-60ce8714f8c5, 1581655353564-df123a1eb820, 1535268647677-300dbf3d78d1
...
def build_enriched_prompt(
    ...
    if image_count == 1:
        base += (
            ...
            "（从约束清单图片库中选取真实 ID，格式：https://images.unsplash.com/photo-{10位数字}-{12位十六进制}?w=375&q=80），"
            "在 WXSS 中参考图片的配色方案。"
        )
    elif image_count > 1:
        base += (
            ...
            "- 背景/场景图 → 提取配色用于 WXSS\n"
            "- 图标/logo → 用于头像区或导航区\n"
            "所有图片都应有实际用途，URL 从约束清单图片库按场景选取（格式：https://images.unsplash.com/photo-{10位数字}-{12位十六进制}?w=375&q=80，每张各不同）"
        )
    return base
...
4. 检查所有 image src：若 photo ID 不是「数字-12位十六进制」格式（如 photo-a1b2c3d4e5f6a7b8 是错误格式）→ 替换为下方图片库中的真实 ID
   图片库（按场景选）：美食: 1514362545857-3bc16c4c7d1b / 1559339352-11d035aa65de / 1467003909585-2f8a72700288 / 1544025162-d76694265947 / 1553621042-f6e147245754 / 1476124369491-e7addf5db371；咖啡: 1497515114629-f71d768fd07c / 1559056199-641a0ac8b55e / 1497636577773-f1231844b336 / 1442550528053-c431ecb55509；时尚: 1490481651871-ab68de25d43d / 1445205170230-053b83016050 / 1503341455253-b2e723bb3dbb；科技: 1518770660439-4636190af475 / 1505740420928-5e560c06d30e / 1523275335684-37898b6baf30；人物: 1494790108377-be9c29b29330 / 1507003211169-0a1dd7228f2d / 1517841905240-472988babdf9；商务: 1497366216548-37526070297c / 1486406146926-c627a92ad1ab；婚礼: 1519741497674-611481863552 / 1511795409834-ef04bbd61622；健身: 1544367567-0f2fcb009e0b / 1535914254981-b5012eebbd15
5. 图片 URL 全为占位符 → 替换为图片库中真实 Unsplash URL（格式：https://images.unsplash.com/photo-{ID}?w=375&q=80）
